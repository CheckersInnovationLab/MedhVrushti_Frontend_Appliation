...
public class SubscriptionPaymentScreen extends AppCompatActivity {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        // Handle success response from the server
                            ...
                            try {
                                Log.d("checkCouponCodeValidity","log2");
                                ...
                                {
                                    Log.d("checkCouponCodeValidity","log3");
    ...
    private void AddUserSubscription(String discountId) {
        Log.d("checkCouponCodeValidity","log5");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url,requestData,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        Log.d("checkCouponCodeValidity","log6");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error.networkResponse != null) {
                            loadingDialog.dismissDialog();
                            Log.d("checkCouponCodeValidity","log8");
    ...
    private void updatingCouponDetails(String discountId) {
        Log.d("checkCouponCodeValidity","log9");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.PUT, url,requestData,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        Log.d("checkCouponCodeValidity","log10");
                        loadingDialog.dismissDialog();
                        dialog.show();
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Log.d("checkCouponCodeValidity","log11");
