...
public class Home_sub_screen_fragment extends Fragment {
    ...
    private ArrayList<HomeSliderModel> sliderDataArrayList;
    private  SliderView homeSliderView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        homeSliderView = view.findViewById(R.id.Home_imageSlider);
    ...
    private void getAdDetails() {
        String Url = StaticFile.Url+"/api/v1/cil/advertisements/get/all";
        RequestQueue requestQueue = Volley.newRequestQueue(getContext());
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            String Url=object.getString("image_url");
                                sliderDataArrayList.add(new HomeSliderModel(Url));
